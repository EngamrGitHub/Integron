...
export const portfolioItems: PortfolioItem[] = [
  {
    ...
    category: "Software",
    year: "2025",
    summary: "A modern app UI with secure authentication and API integration.",
    tags: ["Next.js", "APIs", "UI"],
  ...
  },
  {
    ...
    category: "3D Stands",
    year: "2025",
    summary: "Open-corner booth concept with product demo area and strong branding.",
    tags: ["3D", "Render", "Booth Design"],
    image: "/portfolio-booth.jpg",
  },
  {
    slug: "surveillance-setup",
    title: "Surveillance Setup",
    category: "Security",
    year: "2024",
    summary: "Multi-camera CCTV with NVR setup and monitoring room layout.",
    tags: ["CCTV", "NVR", "Installation"],
  ...
  },
  {
    ...
    category: "Software",
    year: "2024",
    summary: "Storefront + admin dashboard with analytics and order workflow.",
    tags: ["E‑commerce", "Dashboard", "SEO"],
    image: "/portfolio-ecom.jpg",
  },
  {
    slug: "3d-exhibition-design",
    title: "3D Exhibition Design",
    category: "3D Stands",
    year: "2024",
    summary: "Premium 3D design package with renders and shop drawings.",
    tags: ["3D", "DFM", "Drawings"],
    image: "/portfolio-3d.jpg",
  },
  {
    ...
    category: "Security",
    year: "2025",
    summary: "Access control + visitor flow with gate integration.",
    tags: ["Access", "Gate", "RFID"],
    image: "/portfolio-access.jpg",
  },
  {
